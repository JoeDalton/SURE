...
#####################################################
#    Gram-Schmidt orthonormal basis construction    #
#####################################################
# TODO: Check usage, refactor, clean
...
def CompleteBasis(partialBasis):
    ...
    if basisRank != n:
        ErrorMsg(
            "Dear future self, this vector family is ill-conditionned. You must implement a random draw of new basis vectors.",
            fileName)
